        ...
        <header className="flex-shrink-0 relative h-16 bg-white flex items-center">
          ...
          <div className="mx-auto md:hidden">
            <div className="relative">
              <label forhtmlhtml="inbox-select" className="sr-only">
                Choose inbox
              </label>
              <select
                id="inbox-select"
          ...
          <div className="hidden md:min-w-0 md:flex-1 md:flex md:items-center md:justify-between">
            <div className="min-w-0 flex-1">
              <div className="max-w-2xl relative text-gray-400 focus-within:text-gray-500">
                <label forhtml="search" className="sr-only">
                  Search
                </label>
                <input
                  id="search"
                ...
                <div className="relative inline-block text-left">
                  ...
                  >
                    ...
                    <img
                      ...
                      src="https://images.unsplash.com/photo-1517365830460-955ce3ccd263?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=forhtmlmat&fit=facearea&facepad=2&w=256&h=256&q=80"
                      alt=""
                    />
                  </button>
                </div>
          ...
          >
            ...
            <nav
              className="fixed z-40 inset-0 h-full w-full bg-white sm:in https://gist.github.com/mikenieva/d8f8e6b5ca2660dfd8d374c1a2edf6cbset-y-0 sm:left-auto sm:right-0 sm:max-w-sm sm:w-full sm:shadow-lg"
              aria-label="Global"
            >
